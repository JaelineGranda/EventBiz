...
<html>
    ...
    <body>
        ...
        <br>
        <span class="recent">ADD NEW EVENT</span>
        <div class="form">
        <form:form action="/EventBiz/addevent.htm" modelAttribute ="event">
            <form:errors path="*"/>
            <br>
            <br>
            ...
            <br>
            <br>
            Event Date (mm-dd-yyyy)  <form:input path="eventdate" />
            <br>
            <br>
            ...
            <br>
            <br>
            Ticket Price $ <form:input path="price" />
            <br>
            <br>
            <form:hidden path="creatorid" value="${sessionScope.myUser.userid}" />
            Image Name <form:input path="imagefile" />
            <br>
            <br>
            <input class="start" type="submit" value="Add Event"/>
        </form:form>
        </div>
    </body>
</html>
